...
# Module kanged from https://github.com/AlexFlipnote/discord_client.py/blob/master/cogs/fun.py (kanged the utils directory from him for this too!) Thanks!
class Fun_Commands(commands.Cog):
    ...
    async def supreme(self, ctx, *, text: commands.clean_content(fix_channel_mentions=True)):
        ...
        if args.dark and args.light:
            return await ctx.send(f"**{ctx.author.name}**, you can't define clienth --dark and --light, sorry..")
    ...
    async def beer(self, ctx, user: discord.Member = None, *, reason: commands.clean_content = ""):
        ...
        if user.client:
            return await ctx.send(f"I would love to give beer to the client **{ctx.author.name}**, but I don't think it will respond to you :/")
        ...
        try:
            ...
            # Yeah so, client doesn't have reaction permission, drop the "offer" word
